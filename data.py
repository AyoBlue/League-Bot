...
class Client:
    def __init__(self):
        ...
        self.teams = {} # Manually add in all your teams, the key should be the Role Name or ID, Value is the Emoji ID if there is one. If not, leave as "None"
        self.coaches = {} # The key should be the Role Name or ID, and the value should be the abbreviation. Example: "Head Coach": "HC"
